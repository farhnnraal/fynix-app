    ...
    <div className="w-full flex flex-col gap-4 p-6">
      ...
      <div className="w-full flex gap-3 items-stretch">
        <div className="flex-1 bg-white border border-neutral-200 rounded-lg p-[12px] flex items-center gap-3 focus-within:border-primary-500 focus-within:ring-1 focus-within:ring-primary-500 transition-all duration-200">
          ...
          <input type="text" placeholder="Search topic here..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="w-full bg-transparent text-body text-neutral-700 placeholder-neutral-400 outline-none" />
        </div>

        <button type="button" className="aspect-square bg-primary-500 text-white rounded-full flex items-center justify-center outline-none p-3">
